...
def main():
    ...
    # Load demographics
    demo_path = Path(__file__).parent / 'data' / 'zip3_demographics_acs2022.parquet'
    ...
    panel = panel[[
        ...
        'n_users', 'log_users', 'users_pc', 'n_trans', 'total_spend',
    ...
    # Save
    out_path = Path(__file__).parent / 'data' / 'synth_panel.dta'
    ...
    map_path = Path(__file__).parent / 'data' / 'zip3_id_mapping.csv'
